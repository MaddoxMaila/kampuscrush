...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../../static/css/flickity.css" />
	...
	<style type="text/css">
	  ...
	  .app-user-cover-image{
	  	width: 100%;
	  	height: 260px;
	  	border:0.03em solid lightgrey;
	  }
    	...
    	<br />
     	<div class="row main-row">
    		<div class="col-lg-9">
    			...
    			<div class="space-small"></div>
    			<div class="app-user-cover-image"></div>
						...
						<div class="profile-user-info">
										<div class="media">
										  ...
										  <div class="media-left media-top">
										  	 <img width="90" height="90" class="img-circle media-object profile-user-profile-img" />
										  </div>
    		...
    		<div class="col-lg-3 visible-lg">
    			...
    			<div class="user-right-bar">dfgbhnj</div>
    		</div>
