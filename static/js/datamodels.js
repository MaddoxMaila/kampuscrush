...
class UserModel{
	 ...
	 constructor(args){
	 	...
	 	this.basic = {
	 		 ...
	 		 link : `http://localhost/kampuscrush/usr/${args.basic_info.user_athandle}`
...
class MessageModel extends UserModel {
...
class AppIcons{
	...
	icon(args){
		...
		return `<svg id="Layer_2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="${args.width}" height="${args.height}"><path fill="${args.fill == '' ? this.color : args.fill}" fill-opacity="1" d="${args.data}" /></svg>`; 
	}
